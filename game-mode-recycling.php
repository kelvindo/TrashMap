	...
	<body>
		<div data-role="page" id="game-mode">
			...
			<div data-role="content">		
				<a data-role="button" onClick="$.mobile.changePage( 'scavenger-hunt-recycling.php', { transition: 'pop' } );">Scavenger Hunt</a>
				<a data-role="button" onClick="$.mobile.changePage( 'hot-or-cold-recycling.php', { transition: 'pop' } );">Hot or Cold</a>
			</div>
