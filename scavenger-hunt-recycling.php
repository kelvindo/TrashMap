		...
		<div data-role="page" id="scavenger-hunt-recycling">
			...
			<div data-role="popup" id="next-clue-popup1" data-overlay-theme="a" data-theme="c" style="max-width:400px;" class="ui-corner-all">
				...
				<div data-role="content" data-theme="d" class="ui-corner-bottom ui-content">
					...
					<a data-prefetch="true" onClick="$.mobile.changePage( 'scavenger-hunt-clue2-recycling.php', { transition: 'none' } );" data-role="button" data-transition="flow" data-theme="b">Continue</a>  
